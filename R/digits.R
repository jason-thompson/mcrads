#' Round data according to standards or custom requests
#'
#' #' @description
#' By default, this function expects data that has already been formatted for PHI,
...
#'    phi_year = rep(2000:2019),
#'    phi_sex = factor(sample(c("Male", "Female"), 20, rep = TRUE, prob = c(0.5, 0.5))),
