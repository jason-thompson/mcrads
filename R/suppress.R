#' Suppress data according to CES standards or custom requests & adding caution flag for high RSE
#'
#' @description
#' Default suppression is according to CES standards (https://www.doh.wa.gov/Portals/1/Documents/1500/SmallNumbers.pdf)
...
#'
#' This function expects data that has already been formatted for PHI
#'
#'
...
#'
#'
#' @return a data.table with suppression applied to PHI standard columns.
#'
#' @export
#'
...
suppress <- function(sup_data = NULL,
  ...
  #suppress data if has suppression flag
      sup_metrics <- intersect(names(temp.dt), c("result", "lower_bound", "upper_bound", "se", "rse",
                                                 ...
                                                 "comparison_with_mc", "significance", "caution"))
